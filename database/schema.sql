-- SchoolPro PostgreSQL/Neon schema
-- The app can also run this automatically on first request via ensureDatabase().
...
INSERT INTO "school_settings" ("id") VALUES ('main') ON CONFLICT ("id") DO NOTHING;
