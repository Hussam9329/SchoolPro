  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="w-full max-w-md rounded-3xl border border-red-100 bg-white p-8 text-center shadow-xl shadow-red-100/20">
        <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-red-100 to-teal-100 text-red-600">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-600">
          ...
          الاتصال بمصدر البيانات أو خطأ مؤقت في الخادم.
        </p>
        ...
        <button
          type="button"
          onClick={reset}
          className="mt-6 inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-gradient-to-l from-teal-700 to-sky-600 px-6 text-sm font-extrabold text-white shadow-lg shadow-teal-600/25 transition hover:from-teal-800 hover:to-sky-700 hover:shadow-xl"
        >
          <RefreshCw size={18} />
          إعادة المحاولة
        </button>
